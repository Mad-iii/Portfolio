            ...
            {characters.map((char, i) => (
              ...
              >
                <motion.span
                  ...
                  className="text-[12vw] sm:text-[15vw] leading-none font-black text-zinc-900 dark:text-white tracking-tighter"
                >
                  {char === " " ? "\u00A0" : char}
                </motion.span>
                ...
                <motion.span
                  ...
                  className="absolute inset-0 text-[12vw] sm:text-[15vw] leading-none font-black text-indigo-600 dark:text-indigo-400 z-10 pointer-events-none"
                ...
                <motion.span
                  ...
                  className="absolute inset-0 text-[12vw] sm:text-[15vw] leading-none font-black text-zinc-800 dark:text-zinc-200 z-10 pointer-events-none"
                  style={{
